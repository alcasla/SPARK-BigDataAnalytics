...
val model = RandomForest.trainClassifier(reducedRUS, numClasses, categoricalFeaturesInfo, numTrees, featureSubsetStrategy, 
	impurity, maxDepth, maxBins) 
val predsAndLabels = reduceTestdRUS.map { point =>
